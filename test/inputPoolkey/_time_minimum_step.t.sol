...
contract PoolManagerTest is Test, Deployers, GasSnapshot {
    ...
    function test_timeTest(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) public{
        
        uint256 _snapshot = vm.snapshot();

        console.log("time-test-1Day Start.");
        test_initialize_atSpecificTime1Day(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-1Day Done.");

        console.log("time-test-1Week Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime1Week(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-1Week Done.");

        console.log("time-test-1Month Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime1Month(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-1Month Done.");

        console.log("time-test-6Month Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime6Month(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-6Month Done.");

        console.log("time-test-1Year Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime1Year(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-1Year Done.");
        
        console.log("time-test-3Year Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime3Year(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-3Year Done.");

        console.log("time-test-5Year Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime5Year(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-5Year Done.");

        console.log("time-test-7Year Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime7Year(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-7Year Done.");
        
        console.log("time-test-10Year Start.");
        vm.revertTo(_snapshot);
        test_initialize_atSpecificTime10Year(protocolFee0, protocolFee1, amountSpecified, amount0,amount1);
        console.log("time-test-10Year Done.");

    }

    function test_initialize_atSpecificTime1Day(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
    ...
    function test_initialize_atSpecificTime1Week(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
    ...
    function test_initialize_atSpecificTime1Month(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
        ...
        function test_initialize_atSpecificTime6Month(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
    ...
    function test_initialize_atSpecificTime1Year(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
    ...
    function test_initialize_atSpecificTime3Year(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
        ...
        function test_initialize_atSpecificTime5Year(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
        ...
        function test_initialize_atSpecificTime7Year(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
    ...
    function test_initialize_atSpecificTime10Year(uint16 protocolFee0, uint16 protocolFee1, int256 amountSpecified, uint256 amount0, uint256 amount1) internal {
